              ...
              <div className="login_box">
                <div className="login_hero_section">
                  ...
                  <div className="log_hero_topic_continer">
                    <p className="log_hero_topic">Sign up</p>
                    <p className="log_hero_pera">
                      We will send logging information shortly to your
                      registered email.
                    </p>
                  </div>
                </div>
                <div className="login_action_section">
                  <form onSubmit={handleSubmit}>
                    <label className="from_label_login">Full Name</label>
                    <input
                      type="text"
                      name="full_name"
                    ...
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <label className="from_label_login">
                  ...
                  <div className="log_hero_bottom_section">
                    <button className="google_log">
                      <div>
                        <svg
                          ...
                          fill="none"
                        >
                          <g clipPath="url(#clip0_40000007_6232)">
                            <path
                    ...
                    <button className="apple_login">
                      <div>
                        ...
                        >
                          <path
                            d="M20.8418 17.1447C20.5091 17.9133 20.1153 18.6208 19.659 19.2713C19.0371 20.158 18.5278 20.7719 18.1354 21.1127C17.527 21.6722 16.8752 21.9587 16.1772 21.975C15.6761 21.975 15.0718 21.8324 14.3683 21.5432C13.6626 21.2553 13.014 21.1127 12.421 21.1127C11.7991 21.1127 11.132 21.2553 10.4185 21.5432C9.70396 21.8324 9.12831 21.9832 8.68819 21.9981C8.01884 22.0266 7.35166 21.7319 6.68571 21.1127C6.26066 20.742 5.72901 20.1064 5.09212 19.2061C4.40878 18.2446 3.84698 17.1297 3.40686 15.8587C2.93551 14.4857 2.69922 13.1563 2.69922 11.8692C2.69922 10.3948 3.0178 9.12321 3.65592 8.0576C4.15742 7.20166 4.82459 6.52647 5.65962 6.03081C6.49464 5.53514 7.39688 5.28256 8.36852 5.2664C8.90017 5.2664 9.59736 5.43085 10.4637 5.75895C11.327 6.08705 11.8662 6.25483 12.0823 6.25483C12.2708 6.25483 12.8814 6.07128 13.9152 5.70619C14.9737 5.33791 15.8495 5.18705 16.5442 5.2664C18.3156 5.45364 19.6357 6.0901 20.5044 7.17531C18.8344 8.1563 18.0038 9.57916 18.0124 11.4451C18.0199 12.8669 18.4564 14.1486 19.3235 15.2904C19.9415 16.1456 20.4839 16.693 20.8418 17.1447Z"
                            fill="white"
                          />
                        </svg>
                      </div>
