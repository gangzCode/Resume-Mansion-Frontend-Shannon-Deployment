        ...
        <div>
            <div className='OrderPlacedChat_continer'>
                    ...
                    <div className='OrderPlacedChat_top_section_one'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <g clip-path="url(#clip0_40000010_8245)">
                                <path d="M12 21C10.8181 21 9.64778 20.7672 8.55585 20.3149C7.46392 19.8626 6.47177 19.1997 5.63604 18.364C4.80031 17.5282 4.13738 16.5361 3.68508 15.4442C3.23279 14.3522 3 13.1819 3 12C3 10.8181 3.23279 9.64778 3.68508 8.55585C4.13738 7.46392 4.80031 6.47177 5.63604 5.63604C6.47177 4.80031 7.46392 4.13738 8.55585 3.68508C9.64778 3.23279 10.8181 3 12 3C14.3869 3 16.6761 3.94821 18.364 5.63604C20.0518 7.32387 21 9.61305 21 12C21 14.3869 20.0518 16.6761 18.364 18.364C16.6761 20.0518 14.3869 21 12 21Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M10 10C9.5 9 7.5 9 7 10" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M17 10C16.5 9 14.5 9 14 10" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M14.5 15C14.1741 15.3326 13.7852 15.5968 13.3559 15.7772C12.9266 15.9576 12.4656 16.0505 12 16.0505C11.5344 16.0505 11.0734 15.9576 10.6441 15.7772C10.2148 15.5968 9.82588 15.3326 9.5 15" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </g>
                            <defs>
                ...
                <div className='OrderPlacedChat_section_scroll_continer'>
                    <div className='OrderPlacedChat_section_continer'>
                        <div className='OrderPlacedChat_section_one'>
                            <div className='OrderPlacedChat_section_one_icon'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <g clip-path="url(#clip0_40000010_7846)">
                                        <path d="M12 3L20 7.5V16.5L12 21L4 16.5V7.5L12 3Z" stroke="#4A7D06" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M12 12L20 7.5" stroke="#4A7D06" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M12 12V21" stroke="#4A7D06" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M12 12L4 7.5" stroke="#4A7D06" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M16 5.25L8 9.75" stroke="#4A7D06" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                    <defs>
                            ...
                            <p className='OrderPlacedChat_section_one_topic'>You placed the order</p>
                            <p className='OrderPlacedChat_section_one_date'>Oct 02, 7:38 PM</p>
                        </div>
                        <div className='OrderPlacedChat_section_two'>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <path d="M7.65712 1.3335L7.73579 1.33816L7.77513 1.3435L7.81579 1.35216L7.88979 1.37483C7.9409 1.39367 7.98949 1.41875 8.03446 1.4495L8.10379 1.50416L8.27379 1.6495C9.61867 2.76654 11.3184 3.36636 13.0665 3.34083L13.2945 3.33416C13.4435 3.32736 13.5906 3.37077 13.712 3.45743C13.8335 3.54409 13.9224 3.669 13.9645 3.81216C14.2921 4.92655 14.3923 6.09542 14.2592 7.24931C14.1262 8.4032 13.7625 9.51857 13.1899 10.5291C12.6172 11.5397 11.8473 12.4249 10.9258 13.132C10.0043 13.8391 8.95012 14.3538 7.82579 14.6455C7.71605 14.674 7.60087 14.674 7.49112 14.6455C6.36674 14.3539 5.31244 13.8393 4.39088 13.1322C3.46932 12.4251 2.69931 11.5399 2.12661 10.5293C1.5539 9.51876 1.19019 8.40336 1.05709 7.24943C0.923984 6.0955 1.0242 4.92659 1.35179 3.81216C1.39386 3.669 1.48275 3.54409 1.60422 3.45743C1.72569 3.37077 1.87273 3.32736 2.02179 3.33416C3.84677 3.41759 5.63717 2.81682 7.04246 1.6495L7.21779 1.4995L7.28179 1.4495C7.32676 1.41875 7.37535 1.39367 7.42646 1.37483L7.50112 1.35216C7.52725 1.34585 7.55375 1.34118 7.58046 1.33816L7.65712 1.3335ZM10.1305 6.1955C10.0685 6.13351 9.99502 6.08434 9.91409 6.05079C9.83315 6.01724 9.7464 5.99997 9.65879 5.99997C9.57118 5.99997 9.48443 6.01724 9.4035 6.05079C9.32257 6.08434 9.24904 6.13351 9.18713 6.1955L6.99179 8.39016L6.12979 7.52883L6.06712 7.4735C5.93313 7.36989 5.76472 7.32117 5.59611 7.33723C5.42749 7.35329 5.27131 7.43293 5.15929 7.55998C5.04727 7.68702 4.9878 7.85194 4.99297 8.02124C4.99814 8.19054 5.06756 8.35152 5.18712 8.4715L6.52046 9.80483L6.58313 9.86016C6.71139 9.95966 6.87156 10.0089 7.03358 9.99876C7.1956 9.98857 7.34833 9.91961 7.46312 9.80483L10.1298 7.13816L10.1851 7.0755C10.2846 6.94723 10.3339 6.78706 10.3237 6.62504C10.3135 6.46302 10.2446 6.31029 10.1298 6.1955H10.1305Z" fill="#051D14" />
                            </svg>
                            <p className='OrderPlacedChat_section_two_topic'>WE HAVE YOUR BACK</p>
                            <div className='order_line'>

                            </div>
                        </div>
                        <div className='OrderPlacedChat_section_three chat_resivebox'>
                            <p className='OrderPlacedChat_section_three_topic'>Please submit the requirements below to get the job started</p>
                            <div className='OrderPlacedChat_section_three_data'>
                                <p className='OrderPlacedChat_section_three_data_topic'><b>A.</b> Your target job title</p>
                                <p className='OrderPlacedChat_section_three_data_pera'>(Place separate orders if you are targeting multiple industries)</p>
                            </div>
                            <div className='OrderPlacedChat_section_three_data'>
                                <p className='OrderPlacedChat_section_three_data_topic'><b>B.</b> Work experience</p>
                                <p className='OrderPlacedChat_section_three_data_pera'>1. Company</p>
                                <p className='OrderPlacedChat_section_three_data_pera'>2. Position</p>
                                <p className='OrderPlacedChat_section_three_data_pera'>3. Period</p>
                            </div>

                            <div className='OrderPlacedChat_section_three_data'>
                                <p className='OrderPlacedChat_section_three_data_topic'><b>C.</b> Personal details</p>
                                <p className='OrderPlacedChat_section_three_data_pera'>1. Address</p>
                                <p className='OrderPlacedChat_section_three_data_pera'>2. Phone</p>
                                <p className='OrderPlacedChat_section_three_data_pera'>3. Email</p>
                            </div>

                            <div className='OrderPlacedChat_section_three_data'>
                                <p className='OrderPlacedChat_section_three_data_topic'><b>D.</b> Education details</p>
                                <p className='OrderPlacedChat_section_three_data_pera'>1. College/school/university</p>
                                <p className='OrderPlacedChat_section_three_data_pera'>2. Course</p>
                                <p className='OrderPlacedChat_section_three_data_pera'>3. Year</p>
                            </div>
                            <div className='OrderPlacedChat_section_three_data'>
                                <p className='OrderPlacedChat_section_three_data_topic'><b>E.</b> Your current CV/Resume (If you have one)</p>
                            </div>
                            <p className='OrderPlacedChat_section_three_data_sub_topic'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <g clip-path="url(#clip0_40000010_7890)">
                                        <path d="M5.83301 8.056C5.83301 7.46655 6.06716 6.90125 6.48396 6.48445C6.90076 6.06765 7.46606 5.8335 8.05551 5.8335H15.2772C15.569 5.8335 15.858 5.89098 16.1277 6.00267C16.3973 6.11437 16.6423 6.27807 16.8487 6.48445C17.0551 6.69083 17.2188 6.93584 17.3305 7.20548C17.4422 7.47513 17.4997 7.76413 17.4997 8.056V15.2777C17.4997 15.5695 17.4422 15.8585 17.3305 16.1282C17.2188 16.3978 17.0551 16.6428 16.8487 16.8492C16.6423 17.0556 16.3973 17.2193 16.1277 17.331C15.858 17.4427 15.569 17.5002 15.2772 17.5002H8.05551C7.76365 17.5002 7.47464 17.4427 7.20499 17.331C6.93535 17.2193 6.69034 17.0556 6.48396 16.8492C6.27758 16.6428 6.11388 16.3978 6.00219 16.1282C5.89049 15.8585 5.83301 15.5695 5.83301 15.2777V8.056Z" stroke="#0D5438" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M3.34333 13.9475C3.08779 13.8018 2.87523 13.5912 2.72715 13.3371C2.57906 13.0829 2.50071 12.7942 2.5 12.5V4.16667C2.5 3.25 3.25 2.5 4.16667 2.5H12.5C13.125 2.5 13.465 2.82083 13.75 3.33333" stroke="#0D5438" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                    <defs>
                        ...
                        <div className='Receive_msg_con'>
                            <div className='chat_resivebox'>
                                <p className='resive_msg'>Thank you for choosing Resume Mansion! We’ve received your order and are currently reviewing the details. If you have any questions or need further assistance, please don’t hesitate to reach out. We’re here to help you every step of the way!
                        ...
                        <div className='send_msg_con'>
                            <div className='send_msg_box'>
                                <p className='resive_msg'>Hi Resume Mansion, I’ve got couple of CVs, is it okay to upload all of them?</p>
                            </div>
                            <div className='sender_box'>
                        ...
                        <div className='send_msg_con'>
                            <div className='send_msg_box'>
                                <p className='resive_msg'><b>A. Your target job title:</b>UX lead</p><br />
                                <p className='resive_msg'><b>B. Work experience</b></p><br />
                                <p className='resive_msg'>1. Company : Microsfot</p>
                                <p className='resive_msg'>2. Position: UX Designer</p>
                                <p className='resive_msg'>3. Period: 2017-2024 </p><br />
                                <p className='resive_msg'><b>C. Personal details</b></p><br />
                                <p className='resive_msg'>Address: That road, this house</p>
                                <p className='resive_msg'>Phone: (555) 787878</p>
                                <p className='resive_msg'>Email: bestofyasi@gmail.com</p><br />
                                <p className='resive_msg'><b>D. Education details</b></p><br />
                                ...
                                <div className='send_box_cv'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <g clip-path="url(#clip0_283_24471)">
                                            <path d="M15.0007 7.00045L8.50068 13.5005C8.10286 13.8983 7.87936 14.4378 7.87936 15.0005C7.87936 15.5631 8.10286 16.1026 8.50068 16.5005C8.8985 16.8983 9.43807 17.1218 10.0007 17.1218C10.5633 17.1218 11.1029 16.8983 11.5007 16.5005L18.0007 10.0005C18.7963 9.2048 19.2433 8.12567 19.2433 7.00045C19.2433 5.87523 18.7963 4.7961 18.0007 4.00045C17.205 3.2048 16.1259 2.75781 15.0007 2.75781C13.8755 2.75781 12.7963 3.2048 12.0007 4.00045L5.50068 10.5005C4.30721 11.6939 3.63672 13.3126 3.63672 15.0005C3.63672 16.6883 4.30721 18.307 5.50068 19.5005C6.69415 20.6939 8.31285 21.3644 10.0007 21.3644C11.6885 21.3644 13.3072 20.6939 14.5007 19.5005L21.0007 13.0005" stroke="#051D14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        </g>
                                        <defs>
                        ...
                        <div className='Receive_msg_con'>
                            <div className='chat_resivebox'>
                                <p className='resive_msg'>Please tell us your preferred template for your resume. We recommend options A and B for the best impact!</p>
                            </div>
                            <div className='chat_resivebox'>
                                <div className='cv_template_con'>
                                    <div className='cv_template_boxone' style={getBackgroundImage(0)} onClick={() => openModal(0)}>
                                        <p className='cv_template_box_num'>A</p>
                                        <div className='cv_template_box_zome'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <g clip-path="url(#clip0_331_33125)">
                                                    <path d="M2.5 8.33333C2.5 9.09938 2.65088 9.85792 2.94404 10.5657C3.23719 11.2734 3.66687 11.9164 4.20854 12.4581C4.75022 12.9998 5.39328 13.4295 6.10101 13.7226C6.80875 14.0158 7.56729 14.1667 8.33333 14.1667C9.09938 14.1667 9.85792 14.0158 10.5657 13.7226C11.2734 13.4295 11.9164 12.9998 12.4581 12.4581C12.9998 11.9164 13.4295 11.2734 13.7226 10.5657C14.0158 9.85792 14.1667 9.09938 14.1667 8.33333C14.1667 7.56729 14.0158 6.80875 13.7226 6.10101C13.4295 5.39328 12.9998 4.75022 12.4581 4.20854C11.9164 3.66687 11.2734 3.23719 10.5657 2.94404C9.85792 2.65088 9.09938 2.5 8.33333 2.5C7.56729 2.5 6.80875 2.65088 6.10101 2.94404C5.39328 3.23719 4.75022 3.66687 4.20854 4.20854C3.66687 4.75022 3.23719 5.39328 2.94404 6.10101C2.65088 6.80875 2.5 7.56729 2.5 8.33333Z" stroke="black" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M5.83398 8.33301H10.834" stroke="black" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M8.33398 5.83301V10.833" stroke="black" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M17.5 17.5L12.5 12.5" stroke="black" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                                </g>
                                                <defs>
                                    ...
                                    <div className='cv_template_boxtwo' style={getBackgroundImage(1)} onClick={() => openModal(1)}>
                                    ...
                                    <div className='cv_template_boxthree' style={getBackgroundImage(2)} onClick={() => openModal(2)}>
                                            ...
                                            <div className="modal_chat_bot">
                                                ...
                                                <div className="modal_sub">
                                                    ...
                                                    <div className="modal-content">
                                                        <button className="chat_model_arrow left_arrow_chat norml_type_chat_btn" onClick={() => navigateImage('prev')}>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                                                                <mask id="mask0_331_34978" maskUnits="userSpaceOnUse" x="0" y="0" width="30" height="30">
                                                                    <path d="M0 30H30V0H0V30Z" fill="white" />
                                                                </mask>
                                                                <g mask="url(#mask0_331_34978)">
                                                                    <path d="M11.25 23.75L13.0125 21.9875L7.2875 16.25H27.5V13.75H7.2875L13.025 8.0125L11.25 6.25L2.5 15L11.25 23.75Z" fill="white" />
                                                                </g>
                                                            </svg>
                                                        </button>

                                                        <img src={images[currentImageIndex].src} alt="Modal" className='model_image_chat' />

                                                        <button className="chat_model_arrow right_arrow_chat norml_type_chat_btn" onClick={() => navigateImage('next')}>

                                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                                                                <mask id="mask0_331_34985" maskUnits="userSpaceOnUse" x="0" y="0" width="30" height="30">
                                                                    <path d="M30 30H0V0H30V30Z" fill="white" />
                                                                </mask>
                                                                <g mask="url(#mask0_331_34985)">
                                                                    <path d="M18.75 23.75L16.9875 21.9875L22.7125 16.25H2.5V13.75H22.7125L16.975 8.0125L18.75 6.25L27.5 15L18.75 23.75Z" fill="white" />
                                                                </g>
                                                            </svg>
                                                        </button>
                                                    </div>
                                                ...
                                                <div className='res_type_chat_btn'>
                                                    <button className="chat_model_arrow_res left_arrow_chat_res" onClick={() => navigateImage('prev')}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                                                            <mask id="mask0_331_34978" maskUnits="userSpaceOnUse" x="0" y="0" width="30" height="30">
                                                                <path d="M0 30H30V0H0V30Z" fill="white" />
                                                            </mask>
                                                    ...
                                                    <button className="chat_model_arrow_res right_arrow_chat_res" onClick={() => navigateImage('next')}>
                                                ...
                                                <button onClick={() => (window.location.href = '/currentOrder')} className='back_chat_btn'>Back to chat</button>
                                            </div>
                                        </div>
                        ...
                        <div className='Receive_msg_con'>
                            <div className='chat_resivebox'>
                                <p className='resive_msg'>Thanks for sending over the details! We’ve received everything and are now working on crafting your document. Our team is dedicated to ensuring every aspect aligns perfectly with your goals.
                                    We’ll keep you posted on the progress, but feel free to reach out if you have any questions in the meantime!</p>
                            </div>
                            <div className='sender_box'>
                                <div className='auther_continer_blog_card'>
                                    <img src={Avatar} alt='avatar_image' className='avatar_card_blog' />
                        ...
                        <div className='order_status_card'>
                            ...
                            <p className='order_status_card_title'>You submitted the requirements</p>
                            ...
                            <div className='order_status_card_icon_delivered'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <g clip-path="url(#clip0_208_18613)">
                                        <path d="M5 17C5 17.5304 5.21071 18.0391 5.58579 18.4142C5.96086 18.7893 6.46957 19 7 19C7.53043 19 8.03914 18.7893 8.41421 18.4142C8.78929 18.0391 9 17.5304 9 17C9 16.4696 8.78929 15.9609 8.41421 15.5858C8.03914 15.2107 7.53043 15 7 15C6.46957 15 5.96086 15.2107 5.58579 15.5858C5.21071 15.9609 5 16.4696 5 17Z" stroke="#063B26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M15 17C15 17.5304 15.2107 18.0391 15.5858 18.4142C15.9609 18.7893 16.4696 19 17 19C17.5304 19 18.0391 18.7893 18.4142 18.4142C18.7893 18.0391 19 17.5304 19 17C19 16.4696 18.7893 15.9609 18.4142 15.5858C18.0391 15.2107 17.5304 15 17 15C16.4696 15 15.9609 15.2107 15.5858 15.5858C15.2107 15.9609 15 16.4696 15 17Z" stroke="#063B26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M5 17H3V13M2 5H13V17M9 17H15M19 17H21V11M21 11H13M21 11L18 6H13" stroke="#063B26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M3 9H7" stroke="#063B26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                    <defs>
                            ...
                            <div className='order_status_card_icon_revision'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <g clip-path="url(#clip0_208_18638)">
                                        <path d="M15.0001 4.54997C14.0217 4.15601 12.9754 3.9586 11.9207 3.96902C10.8661 3.97944 9.82384 4.19749 8.85347 4.61071C7.8831 5.02393 7.00362 5.62423 6.26524 6.37734C5.52687 7.13045 4.94406 8.02162 4.5501 8.99997C3.75445 10.9758 3.77629 13.1868 4.61083 15.1466C5.44537 17.1064 7.02423 18.6543 9.00009 19.45M9.00009 15V20H4.00009" stroke="#B03200" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M18.3701 7.15997V7.16997" stroke="#B03200" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M13 19.94V19.95" stroke="#B03200" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M16.8398 18.37V18.38" stroke="#B03200" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M19.3701 15.1V15.11" stroke="#B03200" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M19.9404 11V11.01" stroke="#B03200" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                    <defs>
                        ...
                        <div className='order_status_card'>
                            <div className='order_status_card_icon_update'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <g clip-path="url(#clip0_208_18660)">
                                        <path d="M3 12C3 13.1819 3.23279 14.3522 3.68508 15.4442C4.13738 16.5361 4.80031 17.5282 5.63604 18.364C6.47177 19.1997 7.46392 19.8626 8.55585 20.3149C9.64778 20.7672 10.8181 21 12 21C13.1819 21 14.3522 20.7672 15.4442 20.3149C16.5361 19.8626 17.5282 19.1997 18.364 18.364C19.1997 17.5282 19.8626 16.5361 20.3149 15.4442C20.7672 14.3522 21 13.1819 21 12C21 10.8181 20.7672 9.64778 20.3149 8.55585C19.8626 7.46392 19.1997 6.47177 18.364 5.63604C17.5282 4.80031 16.5361 4.13738 15.4442 3.68508C14.3522 3.23279 13.1819 3 12 3C10.8181 3 9.64778 3.23279 8.55585 3.68508C7.46392 4.13738 6.47177 4.80031 5.63604 5.63604C4.80031 6.47177 4.13738 7.46392 3.68508 8.55585C3.23279 9.64778 3 10.8181 3 12Z" stroke="#54009A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M12 12L10 15" stroke="#54009A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M12 7V12" stroke="#54009A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                    <defs>
                            ...
                            <p className='order_status_card_title'>Your delivery date was updated to October 6</p>
                            <p className='order_status_card_date'>Oct 02, 7:38 PM</p>
                        </div>
                                    ...
                                    <div className='doc_name_card_type'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" viewBox="0 0 23 24" fill="none">
                                            <g clip-path="url(#clip0_283_24504)">
                                                <path d="M13.416 3V7C13.416 7.26522 13.517 7.51957 13.6967 7.70711C13.8764 7.89464 14.1202 8 14.3743 8H18.2077" stroke="#D71D1D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.79102 12V5C4.79102 4.46957 4.99295 3.96086 5.35239 3.58579C5.71184 3.21071 6.19935 3 6.70768 3H13.416L18.2077 8V12" stroke="#D71D1D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.79102 18H6.22852C6.60976 18 6.9754 17.842 7.24498 17.5607C7.51457 17.2794 7.66602 16.8978 7.66602 16.5C7.66602 16.1022 7.51457 15.7206 7.24498 15.4393C6.9754 15.158 6.60976 15 6.22852 15H4.79102V21" stroke="#D71D1D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M16.291 18H18.2077" stroke="#D71D1D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M19.166 15H16.291V21" stroke="#D71D1D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M10.541 15V21H11.4993C12.0077 21 12.4952 20.7893 12.8546 20.4142C13.2141 20.0391 13.416 19.5304 13.416 19V17C13.416 16.4696 13.2141 15.9609 12.8546 15.5858C12.4952 15.2107 12.0077 15 11.4993 15H10.541Z" stroke="#D71D1D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            </g>
                                            <defs>
                                    ...
                                    <div className='doc_name_card_dwon'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <g clip-path="url(#clip0_40000010_2744)">
                                                <path d="M6.66602 10.0003L9.99935 13.3337M9.99935 13.3337L13.3327 10.0003M9.99935 13.3337V6.66699M18.3327 10.0003C18.3327 14.6027 14.6017 18.3337 9.99935 18.3337C5.39698 18.3337 1.66602 14.6027 1.66602 10.0003C1.66602 5.39795 5.39698 1.66699 9.99935 1.66699C14.6017 1.66699 18.3327 5.39795 18.3327 10.0003Z" stroke="#063B26" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                            </g>
                                            <defs>
                                    ...
                                    <div className='doc_name_card_type'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            <g clip-path="url(#clip0_283_24515)">
                                                <path d="M14 3V7C14 7.26522 14.1054 7.51957 14.2929 7.70711C14.4804 7.89464 14.7348 8 15 8H19" stroke="#2168E3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M5 12V5C5 4.46957 5.21071 3.96086 5.58579 3.58579C5.96086 3.21071 6.46957 3 7 3H14L19 8V12" stroke="#2168E3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M5 15V21H6C6.53043 21 7.03914 20.7893 7.41421 20.4142C7.78929 20.0391 8 19.5304 8 19V17C8 16.4696 7.78929 15.9609 7.41421 15.5858C7.03914 15.2107 6.53043 15 6 15H5Z" stroke="#2168E3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M20 16.5C20 16.1022 19.842 15.7206 19.5607 15.4393C19.2794 15.158 18.8978 15 18.5 15C18.1022 15 17.7206 15.158 17.4393 15.4393C17.158 15.7206 17 16.1022 17 16.5V19.5C17 19.8978 17.158 20.2794 17.4393 20.5607C17.7206 20.842 18.1022 21 18.5 21C18.8978 21 19.2794 20.842 19.5607 20.5607C19.842 20.2794 20 19.8978 20 19.5" stroke="#2168E3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M12.5 15C12.8978 15 13.2794 15.158 13.5607 15.4393C13.842 15.7206 14 16.1022 14 16.5V19.5C14 19.8978 13.842 20.2794 13.5607 20.5607C13.2794 20.842 12.8978 21 12.5 21C12.1022 21 11.7206 20.842 11.4393 20.5607C11.158 20.2794 11 19.8978 11 19.5V16.5C11 16.1022 11.158 15.7206 11.4393 15.4393C11.7206 15.158 12.1022 15 12.5 15Z" stroke="#2168E3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            </g>
                                            <defs>
                ...
                <div className='chat_area'>
                    <textarea className='chat_box' rows={10} placeholder='Send mesage..' />
                    <div className='chat_area_action_con'>
                        <div className='chat_area_action_con_left'>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <g clip-path="url(#clip0_40000010_8225)">
                                        <path d="M3 12C3 13.1819 3.23279 14.3522 3.68508 15.4442C4.13738 16.5361 4.80031 17.5282 5.63604 18.364C6.47177 19.1997 7.46392 19.8626 8.55585 20.3149C9.64778 20.7672 10.8181 21 12 21C13.1819 21 14.3522 20.7672 15.4442 20.3149C16.5361 19.8626 17.5282 19.1997 18.364 18.364C19.1997 17.5282 19.8626 16.5361 20.3149 15.4442C20.7672 14.3522 21 13.1819 21 12C21 10.8181 20.7672 9.64778 20.3149 8.55585C19.8626 7.46392 19.1997 6.47177 18.364 5.63604C17.5282 4.80031 16.5361 4.13738 15.4442 3.68508C14.3522 3.23279 13.1819 3 12 3C10.8181 3 9.64778 3.23279 8.55585 3.68508C7.46392 4.13738 6.47177 4.80031 5.63604 5.63604C4.80031 6.47177 4.13738 7.46392 3.68508 8.55585C3.23279 9.64778 3 10.8181 3 12Z" stroke="#051D14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M9 10H9.01" stroke="#051D14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M15 10H15.01" stroke="#051D14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M9.5 15C9.82588 15.3326 10.2148 15.5968 10.6441 15.7772C11.0734 15.9576 11.5344 16.0505 12 16.0505C12.4656 16.0505 12.9266 15.9576 13.3559 15.7772C13.7852 15.5968 14.1741 15.3326 14.5 15" stroke="#051D14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                    <defs>
                            ...
                            <button className='chat_area_action_con_roght_btn'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <g clip-path="url(#clip0_40000010_8239)">
                                        <path d="M8.33301 11.6667L17.4997 2.5" stroke="black" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M17.4998 2.5L12.0831 17.5C12.0466 17.5798 11.9879 17.6474 11.914 17.6948C11.8402 17.7422 11.7542 17.7674 11.6665 17.7674C11.5787 17.7674 11.4928 17.7422 11.4189 17.6948C11.3451 17.6474 11.2864 17.5798 11.2498 17.5L8.33315 11.6667L2.49981 8.75C2.42003 8.71344 2.35242 8.65474 2.30502 8.58088C2.25762 8.50701 2.23242 8.4211 2.23242 8.33333C2.23242 8.24557 2.25762 8.15965 2.30502 8.08579C2.35242 8.01193 2.42003 7.95323 2.49981 7.91667L17.4998 2.5Z" stroke="black" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                    <defs>
