                        ...
                        <div className='main_contact_home_section'>
                            ...
                            <div className='lft_colum'>
                                <div className='topic_lft_contat_continer'>
                                    ...
                                    <p className='fome_pera'>We’re to help you with all your inquiries. Please feel free to reach out.  Check out our <span className='faqs'>FAQs</span> page for answers to your common questions.</p>
                                </div>
