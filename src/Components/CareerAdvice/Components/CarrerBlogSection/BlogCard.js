...
function BlogCard() {
    return (
        <div>
            <div className='blog_card' onClick={() => (window.location.href = '/blogPostPage')} >
                ...
                <div className='section_one_topic_continer'>
                    ...
                    <MdArrowOutward className='section_one_topic_section_arrow' onClick={() => (window.location.href = '/blogPostPage')} />
                </div>
